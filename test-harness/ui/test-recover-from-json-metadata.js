...
async function main() {
  ...
  try {
    ...
    // before the first raw callWorker() call below (get-file-paths-with-stats, or - in the --json-tree branch
    // below with no split-plan.json - none of the intervening real-7z-split work that would otherwise provide
    // enough of a natural gap) - see ui/test-add-missing-files.js's identical pause for the full explanation.
